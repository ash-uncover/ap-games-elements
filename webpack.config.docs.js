...
const transformPlugin = (buffer) => {
  ...
  plugin.url = 'https://ash-uncover.github.io/ap-games-elements'
...
module.exports = merge(base, {
  ...
  plugins: [
    ...
    new webpack.EnvironmentPlugin({
      AP_GAMES_ELEMENTS_PLUGIN: 'https://ash-uncover.github.io/ap-games-elements/plugin.json',
      AP_GAMES_ELEMENTS_PUBLIC: '/ap-games-elements',
      AP_GAMES_ELEMENTS_ENVIRONMENT: 'github',
    }),
  ]
})
